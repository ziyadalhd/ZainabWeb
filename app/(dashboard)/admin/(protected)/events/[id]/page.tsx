  ...
  return (
    <main className="admin-page">
      ...
      <section className="mt-7" aria-labelledby="workspace-content-heading">
        ...
        {tab === "registrations" ? <EventRegistrationRoster registrations={registered} eventId={event.id} view="upcoming" emptyTitle="لا توجد تسجيلات بعد" emptyDescription="ستظهر الأسماء هنا عندما تصل تسجيلات لهذه الفعالية." /> : null}
        {tab === "waitlist" ? <EventRegistrationRoster registrations={waitlist} eventId={event.id} view="waitlist" emptyTitle="لا توجد قائمة انتظار" emptyDescription="ستظهر الأسماء هنا عندما تمتلئ الفعالية وتبدأ حجوزات الانتظار." /> : null}
