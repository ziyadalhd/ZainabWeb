...
export default async function AdminSurveysPage() {
  ...
  return <main className="px-4 py-8 sm:px-8"><PageHeader eyebrow="لوحة الإدارة" title="الاستبيانات" description="تظهر التقييمات المرسلة بالاسم فقط عندما تختار المشاركة إظهاره." /><div className="mt-8"><AdminEventFeedbackTable responses={responses} /></div></main>;
}
