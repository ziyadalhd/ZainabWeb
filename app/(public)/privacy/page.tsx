    ...
    <main className="page-shell section-space">
      ...
      <article className="card-surface mt-8 max-w-4xl p-6 sm:p-10">
        ...
        <section className="mt-8">
          ...
          <p className="mt-3 leading-8 muted-copy">تُحذف بيانات التسجيل وطلبات الخدمات تلقائيًا بعد ٩٠ يومًا من انتهاء الغرض التشغيلي المحدد لها، مع الاحتفاظ بالإحصاءات المجهولة فقط عند الحاجة. بيانات المهتمات تُحتفظ بها إلى أن تلغي الاشتراك. لا نبيع البيانات الشخصية. لا تُتاح بيانات الزائرات للمسؤولات إلا بالقدر اللازم لإدارة الخدمة.</p>
        </section>
