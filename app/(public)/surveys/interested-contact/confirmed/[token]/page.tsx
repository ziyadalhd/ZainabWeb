...
export const metadata: Metadata = { title: "سجّلنا اهتمامك", robots: { index: false, follow: false }, alternates: null };
...
export default async function InterestedContactConfirmedPage({ params }: { params: Promise<{ token: string }> }) {
  ...
  return (
    <main className="page-shell section-space">
      <PageHeader eyebrow="اهتمام" title="شكرًا لتسجيل اهتمامك" description="حُفظت موافقتك لإرسال معلومات الفعاليات القادمة." />
