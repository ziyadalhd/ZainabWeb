...
| WhatsApp اليدوي | **Completed** | أضيفت روابط `wa.me` برسالة مجهزة داخل الإدارة فقط، مع تنبيه صريح بأن فتح الرابط لا يعني الإرسال. لا يوجد provider أو إرسال آلي. |
...
| طلبات حجز المساحة والحفلات والورش | **In progress** | نُفذت النماذج العامة بالحقول المعتمدة، والتحقق الخادمي، وتخزين الطلب الآمن، والرابط السري للمتابعة والإلغاء، وقائمة المسؤول وبدء المراجعة. لا تزال واجهة صياغة العرض وقبوله أو رفضه وتعارض التقويم قيد التنفيذ. |
