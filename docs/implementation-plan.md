...
| طلبات حجز المساحة والحفلات والورش | **In progress** | نُفذت النماذج العامة بالحقول المعتمدة، والتحقق الخادمي، وتخزين الطلب الآمن، والرابط السري للمتابعة والإلغاء، وقائمة المسؤول وبدء المراجعة. اكتملت أيضًا صياغة عرض الحجز (السعر والشروط والصلاحية القابلة للتعديل)، قبول/رفض صاحبة الطلب بالرابط الآمن، تسجيل حالة الدفع يدويًا بعد القبول، وتحذير التداخل مع فعاليات وتقويم طلبات النادي. يبقى مسار `bayn-trips` منفصلًا ضمن الفعاليات القياسية. |
