...
| Public UX and shared scheduling refinement | **In Progress** | على `codex/public-ux-refinement`: تبويبات قصة النادي، أقرب فعاليتين، حالات تسجيل واضحة، إطار بوستر موحد، تقويم ميلادي عربي RTL، اختيار وقت 12 ساعة بأرباع الساعة، Turnstile مرن، WhatsApp، ورابط المقر القابل للإدارة. لا نشر إنتاجي قبل المعاينة والاعتماد. |
