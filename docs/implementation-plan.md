...
5. **In progress** — رُبط Preview بمشروع التطوير مع إبقاء Production وDevelopment دون تغيير. تبقى مراجعة الفرق وتقسيم العمل الحالي إلى commits آمنة، ثم قبول صفحات الإدارة بحساب تطوير مستقل.
