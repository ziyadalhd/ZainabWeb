...
- **In Progress** — انتقال الإنتاج: تأكد أن مشروع الإنتاج `bayn-cultural-club` متوقف عند أول 5 migrations، ونجح `db push --dry-run` في تحديد 12 migration أمامية متبقية بالترتيب. قاعدة الإنتاج تحتوي 3 فعاليات، ولا تحتوي تسجيلات أو ملفات تخزين، وحساب مسؤول واحد. لم تُطبق migrations بعد؛ يلزم تأكيد نسخة Supabase المُدارة، ثم تطبيقها في نافذة قطع يتبعها نشر التطبيق مباشرة.
