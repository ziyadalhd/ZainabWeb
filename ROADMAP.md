...
- **In Progress — Public UX refinement** — يجري على `codex/public-ux-refinement` تحسين الرئيسية والفعاليات والبوسترات والنصوص التشغيلية، وتوحيد إدخال التاريخ والوقت في الفعاليات وطلبات الحجز والعروض. يتضمن الفرع رابط المقر المعتمد وTurnstile المرن، ولا يُدمج أو يُنشر إلى Production قبل فحص Preview واعتماد المالك.
