...
- **In Progress — Public UX refinement** — يجري على `codex/public-ux-refinement` تحسين الرئيسية والفعاليات والبوسترات والنصوص التشغيلية، وتوحيد إدخال التاريخ والوقت في الفعاليات وطلبات الحجز والعروض. أُعيدت نسخة المحتوى العام المعتمد من الإنتاج إلى مشروع Supabase التطويري بعد اكتشاف أن صف إعداداته كان شبه فارغ، وحُسّن منتقي الموعد الإداري بأرقام عربية وأرباع ساعة وصياغة محادثية ومنع التمدد الأفقي عند `320px` و`390px`. يتضمن الفرع رابط المقر المعتمد وTurnstile المرن، ولا يُدمج أو يُنشر إلى Production قبل فحص Preview واعتماد المالك.
