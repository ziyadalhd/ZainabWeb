...
- **Completed in development** — نماذج الرسائل والمهتمات والطلبات والعروض والاستبيانات وإعدادات الموقع مطبقة ومختبرة في مشروع التطوير المنفصل.
- **In Progress** — انتقال الإنتاج: تأكد أن مشروع الإنتاج `bayn-cultural-club` متوقف عند أول 5 migrations، ونجح `db push --dry-run` في تحديد 12 migration أمامية متبقية بالترتيب. قاعدة الإنتاج تحتوي 3 فعاليات، ولا تحتوي تسجيلات أو ملفات تخزين، وحساب مسؤول واحد. أُنشئت نسخة محلية مقيدة الصلاحيات لمخطط وبيانات `public` و`private` قبل القطع، وتحقق فهرسها وبصمتها. لم تُطبق migrations بعد؛ الخطوة التالية نافذة قطع تطبق migrations ثم تنشر التطبيق مباشرة.
...
- **In Progress** — مراجعة `web-design-guidelines` للعربية وRTL والوصولية؛ نجحت الفحوص الآلية ومعاينة صفحات عامة ونموذج الموعد على Preview. روجعت جلسة مسؤول فعلية في `2026-08-13` للنظرة العامة والتقويم والفعاليات والطلبات والمسجلين والرسائل على الجوال وسطح المكتب. تحقق على Preview أن موعد الفعالية يستخدم تاريخًا واحدًا وأربع اختيارات للدقائق فقط: تمام وربع ونصف وخمس وأربعين، دون تمدد أفقي أو أخطاء متصفح. حُسنت في الكود صياغة مواعيد طلبات الحجز لتعرض اليوم والتاريخ والوقت بالعربية بدل صيغة قاعدة البيانات. كما حُسنت تجربة المشاركة لتوضح أن رابط تأكيد الحضور يصل عبر واتساب قبل الفعالية، وتنبه إلى عدم التأكيد إلا عند ضمان الحضور مراعاةً لقائمة الانتظار، وأزيلت المصطلحات التقنية من النص العام والنقطة المختصرة في عرض الريال. تنتظر هذه الدفعة Preview جديدة للتحقق البصري النهائي.
