...
- **In Progress — Public UX refinement** — يجري على `codex/public-ux-refinement` تحسين الرئيسية والفعاليات والبوسترات والنصوص التشغيلية، وتوحيد إدخال التاريخ والوقت في الفعاليات وطلبات الحجز والعروض. أُعيدت نسخة المحتوى العام المعتمد من الإنتاج إلى مشروع Supabase التطويري بعد اكتشاف أن صف إعداداته كان شبه فارغ. حُسّن منتقي الموعد الإداري بأرقام عربية وأرباع ساعة وصياغة محادثية، وأصبحت مدة العرض ٤٨ ساعة تلقائيًا مع خيار واضح لموعد مختلف. روجعت الواجهة التشغيلية عند `320×568` و`390×844` و`768×1024` و`1440×900` بلا تمدد أفقي أو أخطاء متصفح. يتضمن الفرع رابط المقر المعتمد وTurnstile المرن، ولا يُدمج أو يُنشر إلى Production قبل فحص Preview واعتماد المالك.
...
- **Completed in production** — Cloudflare Turnstile مفعل على النماذج العامة واختبر بعد إعادة النشر.
